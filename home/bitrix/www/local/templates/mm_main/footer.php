        ...
        <div class="content-container">
            <div class="up-menu">            
                ...
                <? global $USER;
                    ...
                    $arUser = $rsUser->Fetch(); // $arUser['ID'] = 3814, 4446 Шведова
                    //echo "<pre>"; print_r($arUser); echo "</pre>";
                } ?>
                <? if($arUser['ID'] == 3814 || $arUser['ID'] == 4446) : ?>
                    <div class="sale-report-button js-report-button">Отчет по продажам</div>

                    <div class="sale-report-popup-form" id="sale-report-form">
                        <div class="form-overlay">
                            <form action="/pravila-prodazhi/sale-report.php" method="post">
                                <div class="form-overlay--content">
                                    <input type="hidden" name="form_apply" value="Report">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            $('.js-report-button').on("click", function () {
                                //console.log('button');
                                $('#sale-report-form').addClass('sale-report-form--active');
                                $('#sale-report-form .form-overlay').addClass('is-active');
                            });
                            $('button[type="submit"]').on("click", function () {
                                //console.log('button');
                                $('#sale-report-form').removeClass('sale-report-form--active');
                                $('#sale-report-form .form-overlay').removeClass('is-active');
                            });
                        });
                    </script>
                <? endif; ?>
            ...
            <div class="mobile-footer">
                ...
                <div class="mobile-footer__copyright">
                    ...
                    <?/*?><p class="mobile-footer__copyright-mint">Развитие сайта - <a href="https://mediamint.ru" target="_blank">MediaMint</a></p><?*/?>
